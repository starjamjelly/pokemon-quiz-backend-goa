...
func main() {
	...
	{
		logger = log.New(os.Stderr, "[appapi] ", log.Ltime)
	}
	...
	{
		appEndpoints = app.NewEndpoints(appSvc)
	}
	...
	case "0.0.0.0":
		{
			...
			handleHTTPServer(ctx, u, appEndpoints, &wg, errc, logger, *dbgF)
		}

		{
			...
			handleGRPCServer(ctx, u, appEndpoints, &wg, errc, logger, *dbgF)
		}

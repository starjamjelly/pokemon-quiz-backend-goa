...
import (
	...
	appsvr "app/gen/grpc/app/server"
	"context"
	"log"
	"net"
	"net/url"
...
func handleGRPCServer(ctx context.Context, u *url.URL, appEndpoints *app.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		appServer = appsvr.New(appEndpoints, nil)
	}
	...
	apppb.RegisterAppServer(srv, appServer)
